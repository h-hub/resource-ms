<?php
	...
	echo("
		<head>
			...
			<column  type='co' align='left' sort='str'>Admin
				".$myFun->xmlAdmin()."
			</column>
			<column  type='co' align='left' sort='str'>Type
				".$myFun->xmlData('resource_type')."
			</column>
			<column  type='co' align='left' sort='str'>Access
				".$myFun->xmlData('resource_access')."
			</column>
			<settings>
