					...
					<div class="box">
						...
						<table>
							...
							$eventData = new eventData($eid);
								$data= $eventData->userDetail();
								while($detail= mysql_fetch_array($data)){
									echo("<tr><td><strong>User Name</strong></td><td>".$detail[1]."</td></tr>");
									echo("<tr><td><strong>User Email Addres</strong></td><td>".$detail[17]."</td></tr>");
								}
								?>
							</tbody>
						</table>
					...
					<div class="box">
						...
						<?php
							...
							while($data= mysql_fetch_array($eventCr)){
								...
								echo("<tr><td><strong>Event Name</strong></td><td>".$data[4]."</td></tr>");
						...
						<table>
							<tbody>
								<?php
									...
									echo("<tr><td><strong>Event Name</strong></td><td>".$eventData[4]."</td></tr>");
